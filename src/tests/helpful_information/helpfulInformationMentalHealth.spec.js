...
test('[156308] CWA: Helpful Info-Mental Health Resources: I can view "Mental Health" opens in new tab. @smoke-prod-default @smoke-uat-default @smoke-qa-default',async ({page}) => {
