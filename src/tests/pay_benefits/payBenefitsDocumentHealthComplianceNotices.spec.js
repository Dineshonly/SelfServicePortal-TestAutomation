...
test('[227726] CWA Pay&Benefits Page - Download Health Compliance Notices Document @smoke-prod-default @smoke-uat-default @smoke-qa-default',async ({page}) => {
    ...
    // Validate the Health Compliance Notices Document
    const expectedEndOfURL = payBenefitsData.payBenefitsDocumentExpectedURL[0];
    await payBenefitsPage.validatePayBenefitsDocuments(payBenefitsPage.healthComplianceNoticesDocumentdownload,expectedEndOfURL.healthComplianceNoticesExpectedURL,'#Health-Compliance-Notices'); 
})