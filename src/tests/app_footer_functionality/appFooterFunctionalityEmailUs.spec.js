...
test('[229473] CWA: App Footer Functionality: I can view Email Us & I can click on Email Us @smoke-prod-default @smoke-uat-default @smoke-qa-default', async ({page}) => {
    ...
    // Check on Email Us icon
    await stayInTouchWithUsPage.checkForEmailUsIcon();

    // Click on Email Us Icon
    await stayInTouchWithUsPage.checkMailToAssert();
});