...
test('[229468] CWA: App Footer Functionality: I can view Facebook icon & I can open Medical Facebook Page in new tab. @smoke-prod-default @smoke-uat-default @smoke-qa-default', async ({page}) => {
    ...
    await stayInTouchWithUsPage.clickFacebookAndValidateUrl();
});