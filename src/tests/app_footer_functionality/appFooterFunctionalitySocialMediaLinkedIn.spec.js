...
test('[111048] CWA: App Footer Functionality: I can view LinkedIn icon & I can open Medical LinkedIn Page in new tab. @smoke-prod-default @smoke-uat-default @smoke-qa-default', async ({page}) => {
    ...
    // Click on LinkedIn
    await stayInTouchWithUsPage.clickLinkedInAndValidateUrl();
});