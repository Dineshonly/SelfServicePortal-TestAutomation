...
test('[229471] CWA: App Footer Functionality: I can view YouTube icon & I can open Medical YouTube Page in new tab. @smoke-prod-default @smoke-uat-default @smoke-qa-default', async ({page}) => {
    ...
    await stayInTouchWithUsPage.clickYouTubeAndValidateUrl();
});