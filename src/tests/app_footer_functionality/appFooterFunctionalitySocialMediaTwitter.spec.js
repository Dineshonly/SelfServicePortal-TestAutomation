...
test('[229472] CWA: App Footer Functionality: I can view Twitter icon & I can open Medical Twitter Page in new tab. @smoke-prod-default @smoke-uat-default @smoke-qa-default', async ({page}) => {
    ...
    await stayInTouchWithUsPage.clickTwitterAndValidateUrl();
});